      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {categories?.map((category, index) => (
            <Card key={category.id} className="relative overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0 shadow-xl">
              {/* Gradient Header */}
              <div className={`h-20 bg-gradient-to-r ${getCardGradient(index)} relative`}>
              ...
              <CardContent className="space-y-6">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-center flex-1">
                    ...
                    <p className={`text-3xl font-bold bg-gradient-to-r ${getCardGradient(index)} bg-clip-text text-transparent`}>
                      ₹{category.offer_fee}
                    </p>
                  </div>
                </div>
                ...
                <Link to={`/register/${category.id}`} className="block">
                  <Button className={`w-full bg-gradient-to-r ${getCardGradient(index)} hover:opacity-90 text-white py-3 text-lg font-semibold border-0 shadow-lg`}>
                    Register Now
                  </Button>
                </Link>
              </CardContent>
