          ...
          <div className="flex flex-col lg:flex-row items-center gap-8">
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-4">
                ...
                <Badge className="bg-red-600 text-white hover:bg-red-700 text-sm font-bold">
                  SPECIAL OFFER
                </Badge>
                <Star className="h-6 w-6 text-yellow-500 fill-current" />
              </div>
                  ...
                  <CardContent className="p-4">
                    <div className="text-center">
                      <div className="flex items-center justify-center gap-2">
                        <span className="text-sm text-gray-600">Regular Fee:</span>
                        <span className="text-lg line-through text-gray-400">₹{jobCategory.actual_fee}</span>
                      </div>
                      <div className="flex items-center justify-center gap-2 mt-1">
                        <span className="text-sm text-gray-600">Offer Price:</span>
                        <span className="text-2xl font-bold text-green-600">₹{jobCategory.offer_fee}</span>
                      </div>
              ...
              <Link to={`/register/${jobCategory.id}`}>
                <Button size="lg" className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-bold px-8 py-4 text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-200">
